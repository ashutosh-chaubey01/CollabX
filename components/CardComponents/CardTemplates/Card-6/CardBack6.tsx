...
function CardBack6() {
  return (
    <div
      id="card-back"
      className="h-[300px] w-[500px] px-8 py-5  border-2 border-black/80 bg-[#131C2D] flex flex-col justify-center items-center">
      <div className="h-full w-full flex flex-col justify-center items-start gap-1">
        <p className="text-4xl font-medium italic text-[#AF9E77]">Your Name</p>
      ...
      <div className="w-full h-[200px] flex justify-center items-center">
        <div className="h-full w-1/2 border-[#AF9E77]/40 border-t-2 border-b-2 border-r-2 flex flex-col justify-center items-start">
          <p className={design.smallText}>You can write</p>
          <p className={design.smallText}>in this card,</p>
          <p className={design.smallText}>Whatever you want</p>
        </div>
